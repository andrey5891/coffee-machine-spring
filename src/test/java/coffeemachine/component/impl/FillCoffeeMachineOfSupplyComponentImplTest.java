...
public class FillCoffeeMachineOfSupplyComponentImplTest {
    ...
    public static final SupplyModel WATER_SUPPLY_MODEL = SupplyModel.builder().supplyTypeId(WATER_SUPPLY_TYPE_ID).amount(WATER_AMOUNT).build();
    public static final SupplyModel MILK_SUPPLY_MODEL = SupplyModel.builder().supplyTypeId(MILK_SUPPLY_TYPE_ID).amount(MILK_AMOUNT).build();
    public static final SupplyModel COFFEE_SUPPLY_MODEL = SupplyModel.builder().supplyTypeId(COFFEE_SUPPLY_TYPE_ID).amount(COFFEE_AMOUNT).build();
    public static final SupplyModel CUP_SUPPLY_MODEL = SupplyModel.builder().supplyTypeId(CUP_SUPPLY_TYPE_ID).amount(CUP_AMOUNT).build();
    ...
    public static final SupplyModel WATER_SUPPLY_MODEL_WITH_ADD = SupplyModel.builder().supplyTypeId(WATER_SUPPLY_TYPE_ID).amount(WATER_AMOUNT_AFTER_FILL).build();
    public static final SupplyModel MILK_SUPPLY_MODEL_WITH_ADD = SupplyModel.builder().supplyTypeId(MILK_SUPPLY_TYPE_ID).amount(MILK_AMOUNT_AFTER_FILL).build();
    public static final SupplyModel COFFEE_SUPPLY_MODEL_WITH_ADD = SupplyModel.builder().supplyTypeId(COFFEE_SUPPLY_TYPE_ID).amount(COFFEE_AMOUNT_AFTER_FILL).build();
    public static final SupplyModel CUP_SUPPLY_MODEL_WITH_ADD = SupplyModel.builder().supplyTypeId(CUP_SUPPLY_TYPE_ID).amount(CUP_AMOUNT_AFTER_FILL).build();
    ...
    public void fillAllSupplyTest() {
        ...
        when(supplyRepository.getLastBySupplyTypeId(WATER_SUPPLY_TYPE_ID)).thenReturn(Optional.of(waterSupplyBeforeFill));
        when(supplyRepository.getLastBySupplyTypeId(MILK_SUPPLY_TYPE_ID)).thenReturn(Optional.of(milkSupplyBeforeFill));
        when(supplyRepository.getLastBySupplyTypeId(COFFEE_SUPPLY_TYPE_ID)).thenReturn(Optional.of(coffeeSupplyBeforeFill));
        when(supplyRepository.getLastBySupplyTypeId(CUP_SUPPLY_TYPE_ID)).thenReturn(Optional.of(cupSupplyBeforeFill));

        when(supplyRepository.create(waterSupplyAfterFill)).thenReturn(waterSupplyAfterFill);
        when(supplyRepository.create(milkSupplyAfterFill)).thenReturn(milkSupplyAfterFill);
        when(supplyRepository.create(coffeeSupplyAfterFill)).thenReturn(coffeeSupplyAfterFill);
        when(supplyRepository.create(cupSupplyAfterFill)).thenReturn(cupSupplyAfterFill);

        when(supplyRemainingComponent.getRemainingSupply()).thenReturn(supplyModelListAfterFilling);
